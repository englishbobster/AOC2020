defmodule Day3 do
  ...
  def count_trees_for_multiple_slopes(list_of_slopes) do
    list_of_slopes
    |> Enum.map(fn slope -> count_trees(slope) end)
...
#Second star!!
IO.puts(Day3.count_trees_for_multiple_slopes([{1, 1}, {3, 1}, {5, 1}, {7, 1}, {1, 2}]))
